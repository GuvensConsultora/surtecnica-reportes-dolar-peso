    ...
    def action_confirm(self):
        ...
        for order in self:
            if order.manual_currency_rate and order._is_foreign_currency():
                order.message_post(
                    body=f"""
                    <div style="padding: 12px; background: #e8f5e9; border-left: 4px solid #4CAF50; border-radius: 4px; margin: 8px 0;">
                        <div style="margin-bottom: 8px;">
                            <span style="font-size: 16px;">✓</span>
                            <strong style="color: #2e7d32; font-size: 14px;">Presupuesto Confirmado</strong>
                        </div>
